...
public class Homepage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Search by Item Name");

        jButton2.setText("Veiw Staff Rota");

        jButton3.setText("Update Stcok");

        jButton4.setText("Search by Quantity");

        jButton5.setText("Veiw Stock Report");

        jButton6.setText("Veiw Stock Sheet");

        jButton7.setText("Search Item Number");

        jLabel2.setFont(new java.awt.Font("Yu Mincho", 0, 36)); // NOI18N
        jLabel2.setText("SMART-MART STOCK CONTROL SYSTEM");
